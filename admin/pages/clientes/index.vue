<template>
  <div class="w-full flex flex-col gap-4 p-6">
    ...
    <!-- Search & Filters -->
    <div v-else class="border border-gray-200 rounded-xl bg-gray-50/60 p-4 mb-4">
      <div class="flex flex-col md:flex-row gap-4 justify-between">
        ...
        <div class="flex flex-wrap gap-2">
          <button 
            ...
            :class="clientFilter === 'all' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
          >
            Todos
          </button>
          <button 
            ...
            class="px-4 py-2 rounded-lg text-sm font-medium transition-colors"
            :class="clientFilter === 'active' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
          >
            Activos
          </button>
          <button 
            @click="setFilter('vip')" 
            class="px-4 py-2 rounded-lg text-sm font-medium transition-colors"
            :class="clientFilter === 'vip' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
          >
            VIP
          </button>
          <button 
            ...
            class="px-4 py-2 rounded-lg text-sm font-medium transition-colors"
            :class="clientFilter === 'archived' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
          >
            Archivados
          </button>
        </div>
