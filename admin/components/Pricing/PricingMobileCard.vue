  ...
  <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm mb-4">
    ...
    <div class="space-y-3">
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          <label class="text-xs font-medium text-gray-500">Oferta</label>
          <div class="mt-1">
            <input
              v-if="isEditing"
              v-model.number="editValues.oferta"
              type="number"
              step="0.01"
              class="input text-sm h-8"
            ...
            <div v-else class="flex flex-col">
              ...
              <div v-if="displayPrices.oferta > 0" class="text-xs text-red-600 font-medium">
                +{{ getMarginFromPrice(displayPrices.oferta) }}%
              </div>
            </div>
          </div>
        </div>
    ...
    <div v-if="product.trackingType === 'dual'" class="mt-4 pt-4 border-t border-gray-200 space-y-3">
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          <label class="text-xs font-medium text-gray-500">Markup 3+ kg</label>
          <div class="mt-1">
            <input
              v-if="isEditing"
              v-model.number="editValues.threePlusMarkup"
            ...
            <div v-else class="flex flex-col">
              <div class="text-sm font-medium text-gray-900">
                {{ currentThreePlusMarkup.toFixed(1) }}%
              </div>
              <div class="text-xs text-green-600 font-medium">
...
function saveChanges() {
  ...
  if (Math.abs(ofertaValue - (currentPrices.oferta || 0)) > 0.001) {
