...
<body class="bg-canvas text-navy min-h-dvh flex flex-col antialiased">
  ...
  <?php if (!empty($v4Categories)):
    $pinnedCategories = array_slice($v4Categories, 0, 7);
  ?>
  ...
  <div id="mega-panel"
       ...
       style="top: 140px;"
       data-default-slug="<?= htmlspecialchars($v4Categories[0]['slug'] ?? '') ?>">
    <div class="w-full max-w-[1280px] mx-auto px-5">
